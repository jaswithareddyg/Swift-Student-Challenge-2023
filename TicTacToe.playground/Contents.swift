...
class Tile: UIView {
    ...
    func setSelection(change: String) {
        ...
        if selection == "empty" {
            ...
            if change == "x" {
                selection = "x"
                selectionView.backgroundColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
                selectionView.layer.cornerRadius = selectionFrame.width / 6
                playSound(soundName: "Pop", fileType: "wav")
            }
            else {
                selection = "o"
                selectionView.backgroundColor = #colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1)
    ...
    func setWin(x: Bool) {
        ...
        if (x) {
            winFrame.backgroundColor = #colorLiteral(red: 0.9372549057, green: 0.007436680767, blue: 0.258515708, alpha: 0.5)
        }
        else {
            winFrame.backgroundColor = #colorLiteral(red: 0.9372549057, green: 0.5286951866, blue: 0, alpha: 0.5)
        }
